...
/*
In mapper combiner main class where the config and job is initiated. Mapper and reducer classes are set.
...
public class InMapperComb
{
    public static void main( String[] args ) throws Exception {
        ...
        System.out.println("inside in mapper combiner");
        Job job = Job.getInstance(conf, "Climate Analysis");
        job.setJarByClass(InMapperComb.class);
        job.setMapperClass(MapperCombiner.class);
